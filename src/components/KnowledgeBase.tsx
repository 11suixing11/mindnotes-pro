...
export default function KnowledgeBase() {
  ...
  if (!loaded) return <div style={{ width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--text-3)', background: 'var(--card-solid)' }}>加载中...</div>

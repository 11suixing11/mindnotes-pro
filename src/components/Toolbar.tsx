...
export default function Toolbar() {
  ...
  const {
    tool, setTool, brush, setBrush, color, setColor,
    fillColor, setFillColor, size, setSize,
    canvasBg, setCanvasBg, clearAll, addElement,
    ...
    <>
      ...
      <div className="sidebar panel">
        ...
        <div className="sb-group">
          ...
          <button onClick={async () => { if (await confirm('清空所有？')) clearAll() }} className="abtn" data-tip="清空">{I.trash}</button>
        </div>
        <div className="sb-sep" />
        <div className="sb-group">
      ...
      <div className="topbar panel">
        ...
        <button onClick={async () => { if (await confirm('清空画布？')) clearAll() }} className="abtn" data-tip="清屏">{I.clear}</button>

...
function createMockCtx(): any {
  const handler: ProxyHandler<any> = {
    get(_target, prop) {
      ...
      if (prop === 'createLinearGradient' || prop === 'createRadialGradient') return () => mockGradient
...
describe('Canvas', () => {
  beforeEach(() => {
    ...
    useAppStore.setState({
      ...
      bgColor: '#ffffff', selectedIds: [], undoStack: [], redoStack: [],
      loaded: true, docs: [], folders: [], currentDocId: null, sidebarOpen: false,
    })

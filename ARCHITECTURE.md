...
1. `src/components/canvas/usePointerEngine.ts`
   Extracted coordinate, hit-testing, viewport, gesture-threshold, pinch, marquee, and selection-transform primitives; next split per-tool pointer handlers and session cleanup.
